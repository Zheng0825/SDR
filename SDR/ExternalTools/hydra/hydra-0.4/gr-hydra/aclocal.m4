...
m4_include([config/grc_hydra_core.m4])
m4_include([config/grc_hydra_gui.m4])
m4_include([config/grc_hydra_mac.m4])
m4_include([config/grc_hydra_mpif.m4])
m4_include([config/grc_hydra_patch.m4])
m4_include([config/grc_hydra_phy.m4])
m4_include([config/grc_hydra_rf.m4])
m4_include([config/grc_hydra_util.m4])
