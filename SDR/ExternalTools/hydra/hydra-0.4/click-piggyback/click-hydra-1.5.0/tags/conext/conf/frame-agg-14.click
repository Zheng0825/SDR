...
AddressInfo(me 192.168.255.14 ff:0d:c0:a8:ff:0e);
...
AddressInfo(plan13 192.168.255.13 ff:0d:c0:a8:ff:0d);
...
elementclass FromHydraMAC {
  ...
  // extra change needs
  address_filter::Classifier(6/FFFFFFFFFFFF, 6/ff0dc0a8ff0e, - );
...
nb::StaticRouteTable(me:eth me:ip, 8,
 plan12:ip plan13:eth plan13:ip 2,
