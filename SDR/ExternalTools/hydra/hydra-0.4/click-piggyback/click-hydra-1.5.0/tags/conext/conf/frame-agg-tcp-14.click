...
AddressInfo(me 192.168.101.14 ff:0d:c0:a8:65:0e);
...
elementclass MPI {
  // declare
  to_socket::HydraToSocket(UDP, phy_ip, 52141, FRAME 0, SNAPLEN 4096);
  from_socket::HydraFromSocket(UDP, mac_ip, 52142, FRAME 0, SNAPLEN 4096);
...
elementclass FromHydraMAC {
  ...
  // extra change needs
  address_filter::Classifier(6/FFFFFFFFFFFF, 6/ff0dc0a8650e, - );
