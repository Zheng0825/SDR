...
UBAggregator1::UBAggregator1()
    : _verbose(0), _max_aggsize(0), _max_broadcast(10), _max_unicast(10), _unicast_len(0), _broadcast_len(0), _prioritizer(0)
{
...
UBAggregator1::pull(int port)
{
  ...
  // wkim: changed the aggregation criterion based on max_aggsize, not # of aggregated packets. 
