...
AddressInfo(me 192.168.155.14 FF:0D:56:BE:19:14);
...
elementclass FromHydraMAC {
  ...
  // extra change needs
  //address_filter::Classifier(4/FFFFFFFFFFFF, 4/FF0D56BE1914, - );
  address_filter::Classifier(6/FFFFFFFFFFFF, 6/FF0D56BE1914, - );
