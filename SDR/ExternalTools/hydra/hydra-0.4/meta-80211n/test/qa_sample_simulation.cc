...
#define modulation_and_coding_scheme 23 // see XX of 802.11n standard
#define meta_modulation_and_coding_scheme 23 // see XX of 802.11n standard
...
#define number_of_packets_to_run 1 // packets per SNR simulated
#define SNR_value_array "50" // in dB
#define show_sim_messages true // set to true shows simulation messages
...
#include "qa_sample_simulation.h"
...
void qa_sample_simulation::test1()
{
