...
# Generated: Thu Feb 25 16:03:54 2016
##################################################
import threading
...
class broadcastwithFreqNoMac(grc_wxgui.top_block_gui):
    ...
    def __init__(self, ampl=0.7, args='', arq_timeout=.1*0 + 0.04, dest_addr=-1, iface='tun0', max_arq_attempts=5 * 2, mtu=128, ogradio_addr=0, ogrx_freq=915e6, ogtx_freq=915e6, port="12345", rate=1e6, rx_antenna="TX/RX", rx_gain=65-20, rx_lo_offset=0, samps_per_sym=4, tx_gain=45, tx_lo_offset=0):
        ...
        self.blocks_tuntap_pdu_0_0 = blocks.tuntap_pdu("tun1", mtu*0 + 1532, False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_tuntap_pdu_0, 'pdus'), (self.gmsk_radio_selector_0_0, 'msg_in'))    
        self.msg_connect((self.blocks_tuntap_pdu_0_0, 'pdus'), (self.gmsk_radio_selector_0, 'msg_in'))    
        self.msg_connect((self.gmsk_radio_selector_0, 'msg_out'), (self.blocks_tuntap_pdu_0_0, 'pdus'))    
        self.msg_connect((self.gmsk_radio_selector_0_0, 'msg_out'), (self.blocks_tuntap_pdu_0, 'pdus'))    
        ...
        self.connect((self.gmsk_radio_selector_0_0, 1), (self.blocks_complex_to_mag_0, 0))    
        self.connect((self.gmsk_radio_selector_0_0, 0), (self.wxgui_scopesink2_0_0, 0))    
