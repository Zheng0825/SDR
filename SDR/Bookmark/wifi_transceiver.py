...
class wifi_transceiver(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_throttle_0_0, 0), (self.wifi_phy_hier_0, 0))    
        self.connect((self.foo_packet_pad2_0, 0), (self.blocks_throttle_0, 0))    
        self.connect((self.foo_packet_pad2_0_0, 0), (self.blocks_throttle_0_0, 0))    
    ...
    def set_mult(self, mult):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k((self.mult, ))
