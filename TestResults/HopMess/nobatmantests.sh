...
echo "No Batman TTL 255 Packet RX/TX 915/928 Gain 47 " > NoBatTTL255SizeTest1000.txt && ping -c 1000 -t 255 192.168.200.109 >> NoBatTTL255Test1000.txt
...
echo "No Batman 32byte Packet RX/TX 915/928 Gain 47 " > NoBat32bytePacketSizeTest1000.txt && ping -c 1000 -s 24 192.168.200.109 >> NoBat32bytePacketSizeTest1000.txt

espeak "32 Byte Packet Test Complete"

echo "No Batman 16byte Packet RX/TX 915/928 Gain 47 " > NoBat16bytePacketSizeTest1000.txt && ping -c 1000 -s 16 192.168.200.109 >> NoBat16bytePacketSizeTest1000.txt
